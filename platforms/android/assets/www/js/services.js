...
.factory('facebookService', function($q) {
    return {
        getMyLastName: function() { //alert("lnmame");
            var deferred = $q.defer();
            FB.api('/me/friends', {fields: 'name,id,location,birthday'}, function(response) { //alert("res"); 
        ...
        watchAuthenticationStatusChange: function() { //alert("loggg");
          var _self = this;
          FB.Event.subscribe('auth.authResponseChange', function(res) { console.log(res);
